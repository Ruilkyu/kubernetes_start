...
def start_recovery_ansible_hosts():
    ...
    master_ansible_hosts_templates = basedir + '/templates/kubernetes/ansible/recovery_hosts/{0}.yaml'.format(recovery_master_nums)
    try:
    ...
    try:
        ...
        if recovery_master_nums == 1:
            ...
            resultdate = master_ansible_hosts_data.format(master1, port, priority1)
            ...
            resultdate = master_ansible_hosts_data.format(master1, master2, master3, port, priority1, priority2, priority3)
